      ...
      <View style={{ flex: 1, backgroundColor: color.background, alignItems: 'center' }}>
        ...
        <View style={[styles.notificationContainer]}>
          ...
          >
            ...
            {!keyboardOpen && <Text style={{ marginBottom: 20 }}> {localization.en.Tap_to_change_text}</Text>}
            <Text style={{ color: color.text }}>{localization.en.Transactions_notification}</Text>
            ...
            <Text style={{ color: color.text }}> {localization.en.Completion_message}</Text>
            ...
            <Text style={{ color: color.text }}>{localization.en.Expired_message}</Text>
            ...
            <Text style={{ color: color.text }}>{localization.en.Voided_Message}</Text>
            ...
            <Text style={{ color: 'grey' }}>{localization.en.Customer_within_150_meters_of_location}</Text>
