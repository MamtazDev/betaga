      ...
      {urlReady ? (
        <View style={styles.card}>
          <View style={styles.footer}>
            <Text style={{ marginBottom: 20, fontWeight: 'bold', fontSize: 20 }}>{localization.en.Scan_QR_code}</Text>
            ...
            >
              <View style={[styles.button, { backgroundColor: color.action }]}>
                <Text style={{ color: 'white', marginEnd: 10, fontSize: 22 }}> {localization.en.Share_Now}!</Text>
        ...
        <View style={styles.card}>
          <View style={styles.header}>
            <Text style={{ fontWeight: 'bold', fontSize: 20 }}>{localization.en.CREATE_NEW_PASS}</Text>
          </View>
          <Text>{localization.en.One_time_link_only_for_one_customer}</Text>
          <View style={styles.footer}>
          ...
          <View>
            <View style={{ justifyContent: 'flex-start', alignItems: 'center' }}>
              <View>
                <Text>{localization.en.Protect_the_pass}</Text>
                <Text>{localization.en.to_the_customer}.</Text>
              </View>
              <View
                style={{ flexDirection: 'row', justifyContent: 'flex-start', alignItems: 'center' }}
              >
                <Text> {localization.en.Passcode}: </Text>
                <TextInput
                ...
                <Tap style={false} onPress={handleGenerate}>
                  <Text style={{ fontWeight: 'bold' }}>{localization.en.Generate}</Text>
                </Tap>
              </View>
            </View>
            <View
        ...
        {urlReady ? (
          ...
          <TouchableOpacity onPress={handleCreate} style={styles.buttonsWrap}>
            <View style={[styles.button, { backgroundColor: color.action }]}>
              ...
              {localization.en.Create_and_Share_Card}
              </Text>
