      ...
      <View style={{ backgroundColor: color.background, flex: 1 }}>
        ...
        >
          <Div>
            ...
            {localization.en.This_will_effect_all_cards}
            </P>
            <Divider />
            <T s='center mt-20 row'>{localization.en.Tap_to_change_colors_or_logo}</T>
            {/* ==== */}
            <Tap s='row ac js mh-20' disabled={false}>
              <CardSettingsUploadLogo setCardLogoURI={setCardLogoURI} cardSettings={true} />
              <Box s='row jb f'>
                <Div s='row ac'>
                  <T>{localization.en.Logo}</T>
                </Div>
              </Box>
            </Tap>
            {/* ==== */}
            ...
            <Tap s='row ac js mh-20' onPress={() => handleOnPressToRef(2)}>
              ...
              <Box s='row jb f'>
                <Div s='row ac'>
                  <T>{localization.en.Background}: </T>
                  <Input
            ...
            <Tap s='row ac js mh-20' onPress={() => handleOnPressToRef(3)}>
              ...
              <Box s='row jb f'>
                <Div s='row ac'>
                  <T>  {localization.en.Title_Color} : </T>
                  <Input
            ...
            <Tap s='row ac js mh-20' onPress={() => handleOnPressToRef(4)}>
              ...
              <Box s='row jb f'>
                <Div s='row ac'>
                  <T> {localization.en.Text_Color}  : </T>
                  <Input
