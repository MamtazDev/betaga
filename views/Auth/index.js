  ...
  return (
    <View style={{ backgroundColor: color.background, height: '100%' }}>
      ...
      <View style={styles.terms}>
        <Text style={{ color: color.text }}> {localization.en.By_signing_up_you_agree_to_our}</Text>
        <TouchableOpacity onPress={handleTerms}>
          <Text style={[txt.h6, { color: color.text }]}>{localization.en.Terms}</Text>
        </TouchableOpacity>
        <Text style={{ color: color.text }}> {localization.en.and} </Text>
        <TouchableOpacity onPress={handlePolicy}>
          <Text style={[txt.h6, { color: color.text }]}> {localization.en.Policy} </Text>
        </TouchableOpacity>
      </View>
      <BottomButton
